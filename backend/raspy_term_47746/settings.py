"""
Django settings for raspy_term_47746 project.
...
ROOT_URLCONF = 'raspy_term_47746.urls'
...
WSGI_APPLICATION = 'raspy_term_47746.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "raspy_term_47746 API",
    "DESCRIPTION": "API documentation for raspy_term_47746 App",
    "VERSION": "v1",
}
